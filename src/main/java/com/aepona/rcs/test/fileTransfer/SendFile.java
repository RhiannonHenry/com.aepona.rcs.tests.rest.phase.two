...
public class SendFile {
    ...
    public void acceptTransfer() {
        ...
        RestAssured.authentication = RestAssured.basic(contactID, applicationPassword);
        Response response =
                RestAssured.given()
                           .auth()
                           .preemptive()
    ...
    public void mismatchedSenderInURL() {
        ...
        RestAssured.authentication = RestAssured.basic(mismatchedSender, applicationPassword);
        Response response =
                RestAssured.given()
                           .auth()
                           .preemptive()
