...
public class Create {
    ...
    public void subscribeUser1() {
        ...
        // applicationPassword).body(validLongPoll).expect().log().ifError().statusCode(201).
        // body(
        // "notificationChannel.resourceURL",
    ...
    public void subscribeInvalidUser() {
        ...
        RestAssured.authentication = RestAssured.basic(invalidUser, applicationPassword);
        Response response =
                RestAssured.given()
                           .auth()
                           .preemptive()
                           .basic(invalidUser, applicationPassword)
                           .body(validLongPoll)
                           .header("accept", "application/json")
                           .header("Content-Type", "application/json")
                           .expect()
